...
export default function PromoPage() {
  ...
  useEffect(() => {
    ...
    const checkInstalled = () => {
      ...
      const isInstalledPWA = window.navigator.standalone || isStandalone;
  ...
  const handleInstallClick = async () => {
    if (deferredPrompt) {
      ...
      // Show instructions for manual installation if the prompt is not available
      alert(
        "To install the app manually:\n\n" +
        "On Chrome/Edge:\n" +
        "1. Click the install icon (⊕) in the address bar, or\n" +
        "2. Click the menu (⋮) > Install LLM Explorer\n\n" +
        "On Safari (iOS):\n" +
        ...
        <div className="max-w-5xl mx-auto">
          <section className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 text-black">
              Download LLM Explorer
            </h1>
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Get the LLM Explorer app on your device and start learning about
              large language models even when you're offline.
            </p>
            <Button
              size="lg"
              className={`${
            ...
            >
              {isInstalled ? (
                <>
                  <CircleCheck className="mr-2 h-5 w-5" /> App Installed
                </>
              ) : (
                <>
            ...
            {!isInstallable && !isInstalled && (
              <p className="mt-4 text-sm text-gray-600">
                Tip: You can also install the app using your browser's menu options
              </p>
            )}
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <ol className="list-decimal pl-5 space-y-3">
                  <li className="text-gray-700">
                    <span className="font-medium">Visit the app:</span> Open
                    your browser and go to llm-explorer.vercel.app
                  </li>
                  <li className="text-gray-700">
                    <span className="font-medium">On iOS (Safari):</span> Tap
                  ...
                  <li className="text-gray-700">
                    <span className="font-medium">Name and install:</span>{" "}
                    Confirm the name and tap "Add"
                  </li>
                  <li className="text-gray-700">
                    <span className="font-medium">Launch:</span> Open the app
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <ol className="list-decimal pl-5 space-y-3">
                  ...
                  <li className="text-gray-700">
                    <span className="font-medium">Chrome:</span> Click the
                    install icon in the address bar
                  </li>
                  <li className="text-gray-700">
                    <span className="font-medium">Edge:</span> Click the install
                    icon in the address bar
                  </li>
                  <li className="text-gray-700">
                    <span className="font-medium">Firefox:</span> Click the menu
                    button, then "Install app"
                  </li>
                  <li className="text-gray-700">
                    <span className="font-medium">Launch:</span> Open the app
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                ...
                <p className="text-gray-600">
                  Use the app without an internet connection once installed
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                ...
                <p className="text-gray-600">
                  Enjoy quicker access with cached resources for better
                  performance
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                ...
                <p className="text-gray-600">
                  Get a more app-like experience with full-screen mode and home
                  screen icon
                </p>
              </div>
            </div>
